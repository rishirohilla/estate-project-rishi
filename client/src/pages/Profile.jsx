...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setUpdateSuccess(true); // Update updateSuccess state
    } catch (error) {
    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div
          ...
          className="text-slate-600 text-center cursor-pointer"
        >
          Edit Image
        </div>
        <input
        ...
        <Link className="bg-green-600 text-white p-3 rounded-lg uppercase text-center hover:opacity-95 " to={"/create-listing"}>Create Listing</Link>
      </form>
